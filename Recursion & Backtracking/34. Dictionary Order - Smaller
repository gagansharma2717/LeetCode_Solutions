// 34.
// CodingBlocks https://hack.codingblocks.com/app/practice/1/1063/problem
...
// At Base Case, compare string while printing if string is smaller than original given input then only print it.
